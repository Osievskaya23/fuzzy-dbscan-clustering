...
class DBSCANClustererImplTest {
    ...
    void testCluster() {
        ...
        final DBSCANClustererImpl<DoublePoint> transformer =
            new DBSCANClustererImpl<DoublePoint>(2.0, 5);
        ...
        for (final Cluster<DoublePoint> cluster : clusters) {
            if (cluster.getVehicles().containsAll(clusterOne)) {
                cluster1Found = true;
            }
            if (cluster.getVehicles().containsAll(clusterTwo)) {
                cluster2Found = true;
            }
            if (cluster.getVehicles().containsAll(clusterThree)) {
                cluster3Found = true;
            }
        }
    ...
    //    private static void printGeneratedData() {
////        vehicle1s = new Vehicle[]{
////            new Vehicle(1, new double[]{83.08303244924173, 58.83387754182331}),
////            new Vehicle(2, new double[]{45.05445510940626, 23.469642649637535}),
////            new Vehicle(3, new double[]{14.96417921432294, 69.0264096390456}),
////            new Vehicle(4, new double[]{73.53189604333602, 34.896145021310076}),
////            new Vehicle(5, new double[]{73.28498173551634, 33.96860806993209}),
////            new Vehicle(6, new double[]{73.45828098873608, 33.92584423092194}),
////            new Vehicle(7, new double[]{73.9657889183145, 35.73191006924026}),
////            new Vehicle(8, new double[]{74.0074097183533, 36.81735596177168}),
////            new Vehicle(9, new double[]{73.41247541410848, 34.27314856695011}),
////            new Vehicle(10, new double[]{73.9156256353017, 36.83206791547127}),
////            new Vehicle(11, new double[]{74.81499205809087, 37.15682749846019}),
////            new Vehicle(12, new double[]{74.03144880081527, 37.57399178552441}),
////            new Vehicle(13, new double[]{74.51870941207744, 38.674258946906775}),
////            new Vehicle(14, new double[]{74.50754595105536, 35.58903978415765}),
////            new Vehicle(15, new double[]{74.51322752749547, 36.030572259100154}),
////            new Vehicle(16, new double[]{59.27900996617973, 46.41091720294207}),
////            new Vehicle(17, new double[]{59.73744793841615, 46.20015558367595}),
////            new Vehicle(18, new double[]{58.81134076672606, 45.71150126331486}),
////            new Vehicle(19, new double[]{58.52225539437495, 47.416083617601544}),
////            new Vehicle(20, new double[]{58.218626647023484, 47.36228902172297}),
////            new Vehicle(21, new double[]{60.27139669447206, 46.606106348801404}),
////            new Vehicle(22, new double[]{60.894962462363765, 46.976924697402865}),
////            new Vehicle(23, new double[]{62.29048673878424, 47.66970563563518}),
////            new Vehicle(24, new double[]{61.03857608977705, 46.212924720020965}),
////            new Vehicle(25, new double[]{60.16916214139201, 45.18193661351688}),
////            new Vehicle(26, new double[]{59.90036905976012, 47.555364347063005}),
////            new Vehicle(27, new double[]{62.33003634144552, 47.83941489877179}),
////            new Vehicle(28, new double[]{57.86035536718555, 47.31117930193432}),
////            new Vehicle(29, new double[]{58.13715479685925, 48.985960494028404}),
////            new Vehicle(30, new double[]{56.131923963548616, 46.8508904252667}),
////            new Vehicle(31, new double[]{55.976329887053, 47.46384037658572}),
////            new Vehicle(32, new double[]{56.23245975235477, 47.940035191131756}),
////            new Vehicle(33, new double[]{58.51687048212625, 46.622885352699086}),
////            new Vehicle(34, new double[]{57.85411081905477, 45.95394361577928}),
////            new Vehicle(35, new double[]{56.445776311447844, 45.162093662656844}),
////            new Vehicle(36, new double[]{57.36691949656233, 47.50097194337286}),
////            new Vehicle(37, new double[]{58.243626387557015, 46.114052729681134}),
////            new Vehicle(38, new double[]{56.27224595635198, 44.799080066150054}),
////            new Vehicle(39, new double[]{57.606924816500396, 46.94291057763621}),
////            new Vehicle(40, new double[]{30.18714230041951, 13.877149710431695}),
////            new Vehicle(41, new double[]{30.449448810657486, 13.490778346545994}),
////            new Vehicle(42, new double[]{30.295018390286714, 13.264889000216499}),
////            new Vehicle(43, new double[]{30.160201832884923, 11.89278262341395}),
////            new Vehicle(44, new double[]{31.341509791789576, 15.282655921997502}),
////            new Vehicle(45, new double[]{31.68601630325429, 14.756873246748}),
////            new Vehicle(46, new double[]{29.325963742565364, 12.097849250072613}),
////            new Vehicle(47, new double[]{29.54820742388256, 13.613295356975868}),
////            new Vehicle(48, new double[]{28.79359608888626, 10.36352064087987}),
////            new Vehicle(49, new double[]{31.01284597092308, 12.788479208014905}),
////            new Vehicle(50, new double[]{27.58509216737002, 11.47570110601373}),
////            new Vehicle(51, new double[]{28.593799561727792, 10.780998203903437}),
////            new Vehicle(52, new double[]{31.356105766724795, 15.080316198524088}),
////            new Vehicle(53, new double[]{31.25948503636755, 13.674329151166603}),
////            new Vehicle(54, new double[]{32.31590076372959, 14.95261758659035}),
////            new Vehicle(55, new double[]{30.460413702763617, 15.88402809202671}),
////            new Vehicle(56, new double[]{32.56178203062154, 14.586076852632686}),
////            new Vehicle(57, new double[]{32.76138648530468, 16.239837325178087}),
////            new Vehicle(58, new double[]{30.1829453331884, 14.709592407103628}),
////            new Vehicle(59, new double[]{29.55088173528202, 15.0651247180067}),
////            new Vehicle(60, new double[]{29.004155302187428, 14.089665298582986}),
////            new Vehicle(61, new double[]{29.339624439831823, 13.29096065578051}),
////            new Vehicle(62, new double[]{30.997460327576846, 14.551914158277214}),
////            new Vehicle(63, new double[]{30.66784126125276, 16.269703107886016})
////        };
//
////        VanetClusteringUI ui = new VanetClusteringUI();
////        graph = ui.getGraph();
//
//        graph = new DefaultGraph("DBSCAN");
//        graph.display();
//
//        for (int i = 0; i < vehicles.size(); i++) {
////            Node circuleNode = graph.addNode(Integer.toString(vehicles[i].getId() * 100));
////            circuleNode.setAttribute("ui.style", "size: 100px; fill-color: rgba(255,0,0,20);");
////            circuleNode.setAttribute("xy", vehicles[i].getPoint()[0], vehicles[i].getPoint()[1]);
//
//            Node node = graph.addNode(Integer.toString(vehicles.get(i).getId()));
//            node.addAttribute("ui.frozen");
//            node.setAttribute("ui.style", "text-size: 20px;");
//            node.setAttribute("x", vehicles.get(i).getPoint()[0]);
//            node.setAttribute("y", vehicles.get(i).getPoint()[1]);
//            node.setAttribute("ui.label", vehicles.get(i).getId());
//        }
//
//    }
    ...
    void testSingleLink() {
        ...
        final DBSCANClustererImpl<DoublePoint> clusterer = new DBSCANClustererImpl<>(3, 3);
        ...
        Assert.assertTrue(clusters.get(0).getVehicles().containsAll(clusterOne));
    }

    @Test
    void testGetEps() {
        final DBSCANClustererImpl<DoublePoint> transformer = new DBSCANClustererImpl<>(2.0, 5);
    ...
    public void testNegativeEps() {
        Assert.assertThrows(MathIllegalArgumentException.class, () -> {
            new DBSCANClustererImpl<DoublePoint>(-2.0, 5);
        });
    }
    ...
    void testNullDataset() {
        Assert.assertThrows(MathIllegalArgumentException.class, () -> {
            DBSCANClustererImpl<DoublePoint> clusterer = new DBSCANClustererImpl<>(2.0, 5);
